      ...
      <div style={{ position: 'fixed', top: '50%', left: '50%', transform: 'translate(-50%, -50%)', zIndex: 1000, background: '#fff', borderRadius: 20, padding: '32px 24px', width: 'calc(100% - 32px)', maxWidth: 420, boxSizing: 'border-box', boxShadow: '0 20px 60px rgba(27,46,75,0.15)', fontFamily: 'inherit' }}>
        ...
        {signupDone ? (
          <div style={{ textAlign: 'center', padding: '20px 0' }}>
            ...
            <div style={{ fontSize: 18, fontWeight: 700, color: '#034065', marginBottom: 12 }}>
              Vérifiez votre email !
            </div>
            <div style={{ fontSize: 14, color: '#6B7280', lineHeight: 1.7, marginBottom: 24 }}>
              Un email de confirmation a été envoyé à<br />
              <strong style={{ color: '#034065' }}>{email}</strong><br /><br />
              Cliquez sur le lien dans l'email pour activer votre compte avant de vous connecter.
            </div>
            <div style={{ background: '#EAF6E4', borderRadius: 10, padding: '12px 16px', fontSize: 13, color: '#2E7D1E', marginBottom: 20 }}>
              ✓ Vérifiez aussi vos spams si vous ne voyez pas l'email.
            </div>
            <button
              onClick={onClose}
              style={{ width: '100%', padding: '13px', borderRadius: 10, border: 'none', background: '#4CAF2E', color: '#fff', fontSize: 14, fontWeight: 600, cursor: 'pointer', fontFamily: 'inherit' }}
            >
              J'ai compris !
            </button>
          </div>
