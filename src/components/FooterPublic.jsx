...
<div style={{ textAlign: 'center', marginBottom: 28 }}>
  <div style={{ display: 'flex', justifyContent: 'center', gap: 16, marginBottom: 16 }}>
    {/* Instagram */}
    <a href="https://www.instagram.com/startinvest.fr" target="_blank" rel="noopener noreferrer" style={{ width: 40, height: 40, borderRadius: '50%', background: 'linear-gradient(135deg, #f09433, #e6683c, #dc2743, #cc2366, #bc1888)', display: 'flex', alignItems: 'center', justifyContent: 'center', textDecoration: 'none' }}>
    ...
    {/* TikTok */}
    <a href="https://tiktok.com/@startinvest.fr" target="_blank" rel="noopener noreferrer" style={{ width: 40, height: 40, borderRadius: '50%', background: '#000', display: 'flex', alignItems: 'center', justifyContent: 'center', textDecoration: 'none' }}>
    ...
    {/* LinkedIn */}
    <a href="https://www.linkedin.com/in/thomas-bouchard-87187719a" target="_blank" rel="noopener noreferrer" style={{ width: 40, height: 40, borderRadius: '50%', background: '#0A66C2', display: 'flex', alignItems: 'center', justifyContent: 'center', textDecoration: 'none' }}>
  ...
  <div style={{ fontSize: 13, color: 'rgba(255,255,255,0.6)', marginBottom: 6 }}>Une question ? Une recommandation ? Un problème ?</div>
  <a href="mailto:contact@start-invest.fr" style={{ fontSize: 15, fontWeight: 600, color: '#fff', textDecoration: 'none' }}>contact@start-invest.fr</a>
</div>
