          ...
          <div style={{ background: '#fff', border: '0.5px solid #E0EAE3', borderRadius: 14, padding: 20, marginBottom: 12 }}>
            ...
            <div style={{ display: 'flex', gap: 12, marginBottom: 12 }}>
              <div style={{ flex: 1 }}>
                ...
                <input value={prenom} onChange={e => setPrenom(e.target.value)} style={{ width: '100%', padding: '9px 12px', borderRadius: 8, border: '0.5px solid #C8D8CE', fontSize: 14, fontFamily: 'inherit', outline: 'none', color: '#1B2E4B' }} />
              </div>
              <div style={{ flex: 1 }}>
                <div style={{ fontSize: 11, color: '#9CA3AF', marginBottom: 4 }}>Nom</div>
                <input value={nom} onChange={e => setNom(e.target.value)} style={{ width: '100%', padding: '9px 12px', borderRadius: 8, border: '0.5px solid #C8D8CE', fontSize: 14, fontFamily: 'inherit', outline: 'none', color: '#1B2E4B' }} />
              </div>
            </div>
