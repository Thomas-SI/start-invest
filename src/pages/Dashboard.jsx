...
export default function Dashboard() {
  ...
  return (
    <div style={{ background: '#F4F7F5', height: '100vh', display: 'flex', flexDirection: 'column', overflow: 'hidden' }}>
      ...
      {showEcheances && (
        <div style={{ position: 'fixed', inset: 0, background: 'rgba(0,0,0,0.4)', display: 'flex', alignItems: 'center', justifyContent: 'center', zIndex: 100 }}>
          <div style={{ background: '#fff', borderRadius: 16, padding: '28px', width: 520, border: '0.5px solid #E0EAE3', maxHeight: '80vh', overflow: 'auto' }}>
            ...
            <div style={{ borderTop: '0.5px solid #E0EAE3', paddingTop: 16, marginBottom: 16 }}>
              ...
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 8, marginBottom: 8 }}>
                <select value={formEch.categorie} onChange={e => setFormEch({ ...formEch, categorie: e.target.value })} style={{ padding: '8px 10px', borderRadius: 7, border: '0.5px solid #C8D8CE', fontSize: 12, fontFamily: 'inherit', outline: 'none', background: '#fff' }}>
                ...
                <select value={formEch.mois} onChange={e => setFormEch({ ...formEch, mois: e.target.value })} style={{ padding: '8px 10px', borderRadius: 7, border: '0.5px solid #C8D8CE', fontSize: 12, fontFamily: 'inherit', outline: 'none', background: '#fff' }}>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '240px 1fr', gap: 12, padding: 12, flex: 1, minHeight: 0 }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
          ...
          <div style={{ background: '#fff', border: '0.5px solid #E0EAE3', borderRadius: 12, padding: 14, flex: 1 }}>
            ...
            {[
              ...
              ['Disponible', `${Math.round(disponible - totalEcheances)} €`, '#1B2E4B'],
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 10, minWidth: 0 }}>
          ...
          <div style={{ background: '#fff', border: '0.5px solid #E0EAE3', borderRadius: 12, padding: 20, flex: 1 }}>
            <div style={{ fontSize: 14, fontWeight: 500, color: '#1B2E4B', marginBottom: 16 }}>Résumé financier</div>
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 12 }}>
              {[
                ...
                ['Reste après invest.', `${Math.round(disponible - totalEcheances - investissable)} €`, '#1B2E4B'],
              ].map(([l, v, c]) => (
                <div key={l} style={{ background: '#F4F7F5', borderRadius: 10, padding: 14 }}>
                  <div style={{ fontSize: 11, color: '#9CA3AF', marginBottom: 6 }}>{l}</div>
